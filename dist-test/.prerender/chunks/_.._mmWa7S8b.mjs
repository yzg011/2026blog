...
import { a as $$Pagination, i as $$CardGroup, o as $$PostCard, t as getCategoryPaginationPaths } from "./paginationUtils_CZGFUveR.mjs";
import { t as $$BaseCard } from "./BaseCard_DvyPEXx8.mjs";
//#region src/pages/blog/category/[category]/[...page].astro
...
var $$Component = createComponent(($$result, $$props, $$slots) => {
	...
	return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, {
		"title": `${t("label.categoryPage")} - ${params.category}`,
		"isIndexed": false
	...
	})}<h1 id="h1" class="text-2xl md:text-3xl font-bold">${params.category}</h1><div class="badge badge-primary">${page.total} ${page.total === 1 ? t("label.post") : t("label.posts")}</div></div><a href="/blog/categories" class="btn btn-outline btn-sm gap-2">${renderComponent($$result, "Icon", $$Icon, {
		"name": "lucide:folder",
		"class": "w-4 h-4"
	})}<span>${t("label.allCategories")}</span></a></div><div class="divider my-2"></div><p class="text-sm opacity-75">${t("label.categoryDescription")}</p>` })}${renderComponent($$result, "CardGroup", $$CardGroup, {
		"cols": "1",
		"gap": "6"
...
}, "E:/blog/2026blog/src/pages/blog/category/[category]/[...page].astro", void 0);
var $$file = "E:/blog/2026blog/src/pages/blog/category/[category]/[...page].astro";
var $$url = "/blog/category/[category]/[...page]";
//#endregion
//#region \0virtual:astro:page:src/pages/blog/category/[category]/[...page]@_@astro
